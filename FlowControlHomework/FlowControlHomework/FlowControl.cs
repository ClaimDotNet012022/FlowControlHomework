...
namespace FlowControlHomework
{
    ...
    public class FlowControlHomework
    {
        ...
        public void IfWithOperators()
        {
            ...
            int inRange = 7; // Set this value to pass BOTH the range checks, do not reassign it.
        ...
        public void Switch()
        {
            ...
            number = 2; //Assign me so I cause the next switch to pass.
            switch (number)
            {
                case 15:
                    Console.WriteLine(false);
